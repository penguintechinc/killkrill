...
async def get_all_service_status() -> list:
    ...
    services = [
        ...
        {
            "name": "log-receiver",
            "url": f"{config.LOG_RECEIVER_URL}/healthz",
            "type": "internal",
        },
        {
            "name": "metrics-receiver",
            "url": f"{config.METRICS_RECEIVER_URL}/healthz",
            "type": "internal",
        },
        ...
        {
            "name": "elasticsearch",
            "url": f"{config.ELASTICSEARCH_URL}/_cluster/health",
            "type": "external",
        },
        {
            "name": "prometheus",
            "url": f"{config.PROMETHEUS_URL}/-/healthy",
            "type": "external",
        },
        {
            "name": "grafana",
        ...
        {
            "name": "alertmanager",
            "url": f"{config.ALERTMANAGER_URL}/-/healthy",
            "type": "external",
        },
        {
            "name": "fleet-server",
            "url": f"{config.FLEET_SERVER_URL}/healthz",
            "type": "external",
        },
    ]
