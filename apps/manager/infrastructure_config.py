...
class PrometheusConfigAPI:
    ...
    def get_config(self) -> Dict[str, Any]:
        ...
        try:
            response = requests.get(
                f"{self.base_url}/api/v1/status/config", timeout=self.timeout
            )
    ...
    def get_targets(self) -> Dict[str, Any]:
        ...
        try:
            response = requests.get(
                f"{self.base_url}/api/v1/targets", timeout=self.timeout
            )
            response.raise_for_status()
            return response.json()
        except Exception as e:
    ...
    def get_rules(self) -> Dict[str, Any]:
        ...
        try:
            response = requests.get(
                f"{self.base_url}/api/v1/rules", timeout=self.timeout
            )
            response.raise_for_status()
            return response.json()
        except Exception as e:
    ...
    def get_alerts(self) -> Dict[str, Any]:
        ...
        try:
            response = requests.get(
                f"{self.base_url}/api/v1/alerts", timeout=self.timeout
            )
            response.raise_for_status()
            return response.json()
        except Exception as e:
    ...
    def get_metrics(self) -> List[str]:
        ...
        try:
            response = requests.get(
                f"{self.base_url}/api/v1/label/__name__/values", timeout=self.timeout
            )
            response.raise_for_status()
    ...
    def query(self, query: str, time: Optional[str] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.error(
                "Failed to execute Prometheus query", query=query, error=str(e)
            )
            raise
    ...
    def query_range(
        ...
        try:
            ...
            logger.error(
                "Failed to execute Prometheus range query", query=query, error=str(e)
            )
            raise
...
class ElasticsearchConfigAPI:
    ...
    def get_cluster_health(self) -> Dict[str, Any]:
        ...
        try:
            response = requests.get(
                f"{self.base_url}/_cluster/health", timeout=self.timeout
            )
            response.raise_for_status()
            return response.json()
        except Exception as e:
    ...
    def get_cluster_settings(self) -> Dict[str, Any]:
        ...
        try:
            response = requests.get(
                f"{self.base_url}/_cluster/settings", timeout=self.timeout
            )
            response.raise_for_status()
            return response.json()
        except Exception as e:
    ...
    def update_cluster_settings(self, settings: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.error(
                "Failed to update Elasticsearch cluster settings", error=str(e)
            )
            raise
    ...
    def get_indices(self) -> Dict[str, Any]:
        ...
        try:
            response = requests.get(
                f"{self.base_url}/_cat/indices?format=json", timeout=self.timeout
            )
            response.raise_for_status()
            return response.json()
        except Exception as e:
    ...
    def get_index_templates(self) -> Dict[str, Any]:
        ...
        try:
            response = requests.get(
                f"{self.base_url}/_index_template", timeout=self.timeout
            )
            response.raise_for_status()
            return response.json()
        except Exception as e:
    ...
    def create_index_template(
        ...
        try:
            response = requests.put(
                f"{self.base_url}/_index_template/{name}",
                json=template,
                timeout=self.timeout,
            )
            response.raise_for_status()
            ...
            logger.error(
                "Failed to create Elasticsearch index template", name=name, error=str(e)
            )
            raise
    ...
    def get_ilm_policies(self) -> Dict[str, Any]:
        ...
        try:
            response = requests.get(
                f"{self.base_url}/_ilm/policy", timeout=self.timeout
            )
            response.raise_for_status()
            return response.json()
        except Exception as e:
    ...
    def create_ilm_policy(self, name: str, policy: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            response = requests.put(
                f"{self.base_url}/_ilm/policy/{name}", json=policy, timeout=self.timeout
            )
            response.raise_for_status()
            return response.json()
        except Exception as e:
            logger.error(
                "Failed to create Elasticsearch ILM policy", name=name, error=str(e)
            )
            raise
    ...
    def search(self, index: str, query: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            response = requests.post(
                f"{self.base_url}/{index}/_search", json=query, timeout=self.timeout
            )
            response.raise_for_status()
            return response.json()
        except Exception as e:
            logger.error(
                "Failed to execute Elasticsearch search", index=index, error=str(e)
            )
            raise
    ...
    def get_mappings(self, index: str) -> Dict[str, Any]:
        ...
        try:
            response = requests.get(
                f"{self.base_url}/{index}/_mapping", timeout=self.timeout
            )
            response.raise_for_status()
            return response.json()
        except Exception as e:
            logger.error(
                "Failed to get Elasticsearch mappings", index=index, error=str(e)
            )
            raise
    ...
    def update_mapping(self, index: str, mapping: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            response = requests.put(
                f"{self.base_url}/{index}/_mapping", json=mapping, timeout=self.timeout
            )
            response.raise_for_status()
            return response.json()
        except Exception as e:
            logger.error(
                "Failed to update Elasticsearch mapping", index=index, error=str(e)
            )
            raise
...
class KibanaConfigAPI:
    ...
    def get_dashboards(self) -> Dict[str, Any]:
        ...
        try:
            headers = {"kbn-xsrf": "true"}
            response = requests.get(
                f"{self.base_url}/api/saved_objects/_find?type=dashboard",
                headers=headers,
                timeout=self.timeout,
            )
            response.raise_for_status()
...
class GrafanaConfigAPI:
    ...
    def get_datasources(self) -> List[Dict[str, Any]]:
        ...
        try:
            response = requests.get(
                f"{self.base_url}/api/datasources", auth=self.auth, timeout=self.timeout
            )
            response.raise_for_status()
            return response.json()
        except Exception as e:
...
def infrastructure_overview(current_user=None):
    ...
    try:
        ...
        overview = {"timestamp": datetime.utcnow().isoformat(), "components": {}}
        ...
        try:
            ...
            overview["components"]["prometheus"] = {
                "status": "healthy",
                "config_version": prom_config.get("data", {})
                .get("yaml", {})
                .get("__version__", "unknown"),
                "targets_up": len(
                    [
                        t
                        for t in prom_targets.get("data", {}).get("activeTargets", [])
                        if t.get("health") == "up"
                    ]
                ),
                "targets_total": len(
                    prom_targets.get("data", {}).get("activeTargets", [])
                ),
            }
        except Exception as e:
            overview["components"]["prometheus"] = {"status": "error", "error": str(e)}
        ...
        try:
            ...
            overview["components"]["kibana"] = {
                "status": kibana_status_data.get("status", {})
                .get("overall", {})
                .get("state", "unknown"),
                "version": kibana_status_data.get("version", {}).get(
                    "number", "unknown"
                ),
            }
        except Exception as e:
            overview["components"]["kibana"] = {"status": "error", "error": str(e)}
        ...
        try:
            ...
            overview["components"]["grafana"] = {
                "status": (
                    "healthy"
                    if grafana_health_data.get("database") == "ok"
                    else "degraded"
                ),
            ...
            overview["components"]["grafana"] = {"status": "error", "error": str(e)}
