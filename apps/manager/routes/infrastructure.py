...
async def databases():
    ...
    with open(
        "/home/penguin/code/killkrill/apps/manager/templates/databases.html", "r"
    ) as f:
        template = f.read()
...
async def infrastructure():
    ...
    with open(
        "/home/penguin/code/killkrill/apps/manager/templates/infrastructure.html", "r"
    ) as f:
        template = f.read()
    return await render_template_string(template)
...
async def monitoring():
    ...
    with open(
        "/home/penguin/code/killkrill/apps/manager/templates/monitoring.html", "r"
    ) as f:
        template = f.read()
    return await render_template_string(template)
...
async def security():
    ...
    with open(
        "/home/penguin/code/killkrill/apps/manager/templates/security.html", "r"
    ) as f:
        template = f.read()
    return await render_template_string(template)
...
async def fleet_config():
    ...
    with open(
        "/home/penguin/code/killkrill/apps/manager/templates/fleet_config.html", "r"
    ) as f:
        template = f.read()
    return await render_template_string(template)
...
async def logs():
    """System logs viewer"""
    with open(
        "/home/penguin/code/killkrill/apps/manager/templates/logs.html", "r"
    ) as f:
        template = f.read()
    return await render_template_string(template)
