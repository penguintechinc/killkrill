export const theme = {
  ...
  shadows: {
    ...
    glowHover:
      "0 0 16px rgba(212, 175, 55, 0.5), 0 0 24px rgba(212, 175, 55, 0.2)",
  },
  ...
  gradients: {
    ...
    lightAccent:
      "linear-gradient(135deg, rgba(212, 175, 55, 0.1), rgba(229, 192, 75, 0.1))",
  },
  ...
  components: {
    ...
    cardHover: {
      ...
      boxShadow:
        "0 8px 16px rgba(0, 0, 0, 0.5), 0 0 12px rgba(212, 175, 55, 0.2)",
