        ...
        <table style={{ width: "100%", borderCollapse: "collapse" }}>
          <thead>
            <tr style={{ backgroundColor: "#333" }}>
              <th
                style={{ padding: "1rem", textAlign: "left", color: "#d4af37" }}
              >
                Username
              </th>
              <th
...
const LicenseTab = () => {
  ...
  const validateLicense = async () => {
    ...
    setError("");
    try {
      const response = await fetch("/api/v1/licensing/validate", {
        method: "POST",
        headers: { Authorization: `Bearer ${localStorage.getItem("token")}` },
      });
      const data = await response.json();
                ...
                {license.features.map((feature, idx) => (
                  <div
                    ...
                    style={{
                      ...
                      backgroundColor: "#1a1a1a",
                      borderRadius: "4px",
                      border: `1px solid ${feature.entitled ? "#4488ff" : "#444"}`,
                    }}
                  >
                    <div
                      style={{
                    ...
                    >
                      ...
                      <span
                        style={{
                          padding: "0.5rem 1rem",
                          borderRadius: "4px",
                          backgroundColor: feature.entitled
                            ? "#1a3a1a"
                            : "#3a1a1a",
                          color: feature.entitled ? "#44ff44" : "#ff4444",
                          fontWeight: "bold",
                          fontSize: "0.9rem",
                        }}
                      >
