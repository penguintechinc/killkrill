...
const Sensors = () => {
    ...
    <div>
      <div style={{
        ...
        <button
          ...
          onMouseEnter={(e) => {
            e.target.style.boxShadow = theme.components.button.primaryHover.boxShadow;
            e.target.style.transform = theme.components.button.primaryHover.transform;
          }}
          onMouseLeave={(e) => {
            e.target.style.boxShadow = theme.components.button.primary.boxShadow;
    ...
    <div>
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
          <h2 style={{ color: theme.colors.primary.gold, margin: 0 }}>Checks</h2>
          <select
            value={filterType}
  ...
  const renderResults = () => (
    <div>
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
          <h2 style={{ color: theme.colors.primary.gold, margin: 0 }}>Results</h2>
          <select
            value={filterType}
            onChange={(e) => setFilterType(e.target.value)}
            style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <h2 style={{
            ...
            {modalMode === 'create' ? 'Create' : 'Edit'} {modalType === 'agent' ? 'Agent' : 'Check'}
          </h2>
  ...
  return (
    <div style={{
      ...
      <h1 style={{ color: theme.colors.primary.gold, marginBottom: '2rem' }}>Sensors</h1>
