  ...
  const analysisTypes = [
    {
      ...
      description: "Detect unusual patterns in logs and metrics",
    },
    {
      id: "prediction",
    ...
    },
    {
      ...
      description: "Categorize and classify log entries",
    },
    {
      id: "correlation",
      label: "Event Correlation",
      description: "Find relationships between events",
    },
    {
      id: "optimization",
    ...
    >
      ...
      <div style={{ ...cardStyle, marginTop: "1.5rem" }}>
        ...
        <div style={{ display: "grid", gap: "1rem" }}>
          {insights.length === 0 ? (
            <p style={{ color: "#999" }}>
              No insights available yet. Submit data for analysis to generate
              insights.
            </p>
          ) : (
      ...
      <div style={{ ...cardStyle, marginTop: "1.5rem" }}>
        ...
        <div style={{ display: "grid", gap: "1rem" }}>
          {recommendations.length === 0 ? (
            <p style={{ color: "#999" }}>
              No recommendations available. Submit data for analysis to receive
              recommendations.
            </p>
          ) : (
      ...
      <div style={{ ...cardStyle, marginTop: "1.5rem" }}>
        ...
        <div style={{ display: "grid", gap: "1rem" }}>
          {recentAnalyses.length === 0 ? (
            <p style={{ color: "#999" }}>
              No recent analyses. Submit data above to get started.
            </p>
          ) : (
