...
const Dashboard = () => {
  ...
  const fetchDashboardData = async () => {
    try {
      ...
      const [overviewRes, servicesRes, metricsRes, activityRes] = await Promise.all([
  ...
  if (loading && !stats) {
    return (
      <div style={{
        ...
        <h1 style={{ color: theme.colors.primary.gold, marginBottom: '2rem' }}>Dashboard</h1>
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <h1 style={{ color: theme.colors.primary.gold, margin: 0 }}>Dashboard</h1>
        <button
          ...
          onMouseEnter={(e) => {
            ...
            e.target.style.boxShadow = theme.components.button.secondaryHover.boxShadow;
          }}
          onMouseLeave={(e) => {
      ...
      <div style={{
        ...
        {stats && [
          ...
          >
            ...
            {stat.change && (
              <p style={{
                color: stat.change.startsWith('+') ? theme.colors.status.success : theme.colors.status.error,
                fontSize: theme.typography.fontSize.sm,
      ...
      <div style={{
        ...
        <div style={{
          ...
          {services.length > 0 ? services.map((service, idx) => (
            ...
            <p style={{ color: theme.colors.text.secondary }}>No services available</p>
          )}
        </div>
      </div>
      ...
      <div style={{
        ...
        <div style={{ maxHeight: '400px', overflowY: 'auto' }}>
          {activity.length > 0 ? activity.map((item, idx) => (
            ...
            <p style={{ color: theme.colors.text.secondary }}>No recent activity</p>
          )}
        </div>
      </div>
    </div>
