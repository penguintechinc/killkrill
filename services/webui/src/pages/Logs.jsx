  ...
  const fetchLogs = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `/api/v1/infrastructure/elasticsearch/search?${params}`,
        {
      ...
      >
        ...
        <div style={{ display: "flex", gap: "1rem", flexWrap: "wrap" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "0.5rem" }}>
            ...
            <label
              htmlFor="autoRefresh"
              style={{ color: "#999", fontSize: "0.9rem", cursor: "pointer" }}
            >
              Auto-refresh (5s)
            </label>
          </div>
            ...
            return (
              <div
                ...
                style={{
                  ...
                  backgroundColor:
                    selectedLog?._id === log._id ? "#3a3a3a" : "transparent",
                }}
                onMouseEnter={(e) =>
              ...
              >
                ...
                >
                  ...
                  >
                    {src.timestamp || src["@timestamp"] || "No timestamp"}
                  </span>
                  <span
                    style={{
                      color: "#999",
                  ...
                  >
                    {src.source || src.hostname || "Unknown"}
                  </span>
                  <span style={{ color: "#fff", flex: "1" }}>
                    {src.message || JSON.stringify(src).substring(0, 100)}
                  </span>
                </div>
              </div>
            );
