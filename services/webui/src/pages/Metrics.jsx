...
const Metrics = () => {
  ...
  const prebuiltQueries = [
    ...
    {
      name: "Network RX",
      query: "rate(network_receive_bytes_total[5m])",
      unit: "B/s",
    },
    {
      name: "Network TX",
      query: "rate(network_transmit_bytes_total[5m])",
      unit: "B/s",
    },
  ...
  const executeQuery = async (promqlQuery) => {
    ...
    try {
      ...
      const response = await fetch(
        `/api/v1/infrastructure/prometheus/query?${params}`,
        {
  ...
  return (
    ...
    >
      <h1 style={{ color: "#d4af37", marginBottom: "1.5rem" }}>
        Metrics Viewer
      </h1>
      ...
      >
        <h2
          style={{ color: "#d4af37", marginBottom: "1rem", fontSize: "1.2rem" }}
        >
          PromQL Query
        </h2>
      ...
      >
        ...
        >
          {[
            ...
            {
              desc: "Memory by service",
              query: "sum by (service) (process_resident_memory_bytes)",
            },
          ].map((example, idx) => (
            <div
              key={idx}
            ...
            >
              ...
              <code style={{ color: "#d4af37", fontSize: "0.85rem" }}>
                {example.query}
              </code>
            </div>
          ))}
