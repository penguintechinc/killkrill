...
class TestPrometheusDestination:
    ...
    @patch("requests.post")
    def test_prometheus_destination_initialization(
        self, mock_post, mock_prometheus_gateway
    ):
    ...
    def test_add_metric_success(
        self, mock_post, mock_prometheus_gateway, sample_metric_data
    ):
    ...
    @patch("requests.post")
    def test_push_metrics_formats_prometheus_text(
        self, mock_post, mock_prometheus_gateway
    ):
    ...
    @patch("requests.post")
    def test_push_metrics_handles_connection_error(
        self, mock_post, mock_prometheus_gateway
    ):
...
class TestMetricsProcessor:
    ...
    def test_processor_stops_workers(self):
        ...
        processor.workers = [(mock_worker1, mock_thread1), (mock_worker2, mock_thread2)]
...
class TestMetricEntry:
    ...
    def test_metric_entry_invalid_type(self):
        ...
        with pytest.raises(pydantic.ValidationError):
            MetricEntry(
                name="test", type="gauge", value="not_a_number"  # Should be float
            )
    ...
    def test_metric_entry_optional_defaults(self):
        ...
        entry = MetricEntry(name="minimal_metric", type="counter", value=1.0)
...
class TestEdgeCasesAndErrors:
    ...
    def test_metric_with_very_large_value(self):
        ...
        entry = MetricEntry(
            name="large_metric", type="gauge", value=1e15  # Very large number
        )
    ...
    def test_metric_with_zero_value(self):
        ...
        entry = MetricEntry(name="zero_metric", type="gauge", value=0.0)
    ...
    def test_metric_with_negative_value(self):
        ...
        entry = MetricEntry(name="negative_metric", type="gauge", value=-42.5)
    ...
    def test_metric_with_empty_labels(self):
        ...
        entry = MetricEntry(
            name="metric_no_labels", type="gauge", value=10.0, labels={}
        )
    ...
    def test_metric_with_many_labels(self):
        ...
        entry = MetricEntry(
            name="metric_many_labels", type="gauge", value=10.0, labels=labels
        )
