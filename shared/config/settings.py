    ...
    def from_env(cls) -> 'KillKrillConfig':
        ...
        return cls(
            ...
            redis_url=config('REDIS_URL',
                           default='redis://:killkrill123@redis:6379'),
            ...
            jwt_secret=config('JWT_SECRET',
                            default='killkrill-secret-change-in-production'),
            ...
            # Network settings
            syslog_port_start=config('RECEIVER_SYSLOG_PORT_START', default=10000, cast=int),
            ...
            prometheus_push_interval=config('PROMETHEUS_PUSH_INTERVAL', default=15, cast=int),

            # Performance settings
            redis_max_connections=config('REDIS_MAX_CONNECTIONS', default=100, cast=int),
